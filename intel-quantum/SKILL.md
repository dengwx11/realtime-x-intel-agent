...
用 Write 工具保存到今日文件夹：
`/Users/amber/Documents/Obsidian Vault/Areas/Quantum/Sources/Intel/{YYYY-MM-DD}/{YYYYMMDDTHHMMSS}--quantum-intel__daily.md`
...
1. 用 Bash 打开情报文件：
   ```bash
   open "/Users/amber/Documents/Obsidian Vault/Areas/Quantum/Sources/Intel/{YYYY-MM-DD}/{quantum_filename}"
   ```
